...
func init() {
	functions.HTTP("DeleteTopic", TrensentimenDeleteTopic)
}

func TrensentimenDeleteTopic(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Access-Control-Allow-Origin", "https://trensentimen.my.id")
	fmt.Fprintf(w, module.GCFHandlerDeleteTopic("PASETOPUBLICKEY", "MONGOSTRING", "trensentimen", "topic", r))
